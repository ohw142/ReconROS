...
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { PWM_OUT_0 }]; #IO_L19N_T3_VREF_13 Sch=ck_io[26]
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { PWM_OUT_1 }]; #IO_L6N_T0_VREF_13 Sch=ck_io[27]
