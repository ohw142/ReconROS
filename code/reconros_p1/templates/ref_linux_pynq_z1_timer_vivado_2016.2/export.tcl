...
proc reconos_hw_setup {new_project_name new_project_path reconos_ip_dir} {
	...
	#
	# Route general purpose signals of slot 3 to PWM output pins
	#
	create_bd_port -dir O PWM_OUT_0
	create_bd_port -dir O PWM_OUT_1
	
	create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_0
	set_property -dict [list CONFIG.DIN_WIDTH {8} CONFIG.DIN_TO {0} CONFIG.DIN_FROM {0} CONFIG.DOUT_WIDTH {1}] [get_bd_cells xlslice_0]
	create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_1
	set_property -dict [list CONFIG.DIN_WIDTH {8} CONFIG.DIN_TO {1} CONFIG.DIN_FROM {1} CONFIG.DOUT_WIDTH {1}] [get_bd_cells xlslice_1]
	
	connect_bd_net [get_bd_pins slot_3/GP_OUT] [get_bd_pins xlslice_0/Din]
	connect_bd_net [get_bd_pins slot_3/GP_OUT] [get_bd_pins xlslice_1/Din]
	connect_bd_net [get_bd_ports PWM_OUT_0] [get_bd_pins xlslice_0/Dout]
	connect_bd_net [get_bd_ports PWM_OUT_1] [get_bd_pins xlslice_1/Dout]
