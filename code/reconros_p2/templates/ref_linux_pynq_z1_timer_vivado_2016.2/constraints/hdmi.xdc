...
#create_clock -period 6.900 -name output_video -waveform {0.000 3.450} [get_pins design_1_i/dvi2rgb_1/PixelClk]
#create_clock -period 8.334 -waveform {0.000 4.167} [get_ports hdmi_in_clk_n]
