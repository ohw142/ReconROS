...
int main(int argc, char **argv) {
  ...
  ROS_DEBUG("Create subscriber");
  ros::Subscriber config_sub = n.subscribe<reconros_car_msgs::CarConfiguration>("configuration1",10, boost::bind(configCallback, _1, boost::ref(config)));
